...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Article = __webpack_require__(95);
	
	var _Article2 = _interopRequireDefault(_Article);
	
	var _TagArticleList = __webpack_require__(105);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    route: {
	        data: function data(transition) {
	            ...
	            _store2.default.getArticles.then(function (data) {
	                ...
	                // when the data changes,trigger the view change
	                _store2.default.getArticlesByPage(page).then(function (data) {
	                    self.handleData(data);
	                    self.items = data;
	                    self.page = page;
	                });
	    ...
	    methods: {
	        ...
	        getPages: function getPages(allPages) {
	            var limit = Math.ceil(allPages / _store2.default.perPage);
	            this.pages = limit;
	            this.limit = limit;
	        }
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	store.getAllInfo = function (articleUrl, tagUrl) {
	    return _es6Promise.Promise.all([store.getArticles, store.getRequestInfo(tagUrl)]);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3), (function() { return this; }()), __webpack_require__(38)(module)))
...
/***/ function(module, exports) {
	...
	var apiUrl = 'http://121.40.224.83:8001/api';
	...
	exports.default = {
	    ...
	    route: {
	        data: function data(transition) {
	            ...
	            var articleId = transition.to.params._id;
	            var singleArticleUrl = _url2.default.articleUrl + '?_id=' + articleId;
	
	            _store2.default.getRequestInfo(singleArticleUrl).then(function (data) {
	                var data = data[0];
	...
	exports.default = {
	    ...
	    route: {
	        data: function data(transition) {
	            ...
	            _store2.default.getAllInfo(articleUrl, tagUrl).then(function (data) {
	                var articleData = data[0];
	                var tagData = data[1];
